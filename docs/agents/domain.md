...
exploring the codebase. **Layout: single-context** — one `CONTEXT.md` +
`docs/adr/` at the repo root.

## Before exploring, read these

- **`CONTEXT.md`** at the repo root — the project's domain glossary and ubiquitous
  language.
...
├── CONTEXT.md
├── docs/adr/
│   ├── 0001-torch-free-gpu-detection.md
│   └── 0002-openai-compatible-summarization.md
└── src/hearsay/
```
...
> _Contradicts ADR-0002 (OpenAI-compatible summarization) — but worth reopening
> because…_
